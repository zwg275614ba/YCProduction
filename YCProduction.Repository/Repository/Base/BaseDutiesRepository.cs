...
{
    public class BaseDutiesRepository:BaseRepository<BaseDuties>, IBaseDutiesRepository
    {
        public BaseDutiesRepository(YCProductionDBContext dbContext) : base(dbContext)
        {
        }
    }
}
