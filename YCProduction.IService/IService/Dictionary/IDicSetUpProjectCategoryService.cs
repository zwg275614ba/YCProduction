...
{
    public interface IDicSetUpProjectCategoryService:IBaseService<DicSetUpProjectCategory>
    {
        Task<PagedData<DicSetUpProjectCategory>> LoadListPage(SetUpProjectCategoryParam projectCategoryParam);
    }
}
