#pragma checksum "C:\Users\Administrator\source\repos\YCProduction\YCProduction.Web\Areas\System\Views\User\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7e3e0ef25e78740289e3209d9f68f7efdde81236"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7e3e0ef25e78740289e3209d9f68f7efdde81236", @"/Areas/System/Views/User/Index.cshtml")]
    #nullable restore
...
#nullable disable
            ...
            BeginWriteAttribute("action", " action=\"", 242, "\"", 251, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""test-table-switchTpl"">
    <input type=""checkbox"" name=""Status"" lay-skin=""switch"" lay-text=""开启|关闭"" lay-filter=""table-State""
           value=""{{d.Id}}"" data-json=""{{ encodeURIComponent(JSON.stringify(d)) }}"" {{");
            BeginWriteAttribute("d.Status", " d.Status =", 1599, "", 1610, 0);
            EndWriteAttribute();
...
<script type=""text/html"" id=""test-table-switchTp2"">
    <input type=""checkbox"" name=""IsPwd"" lay-skin=""switch"" lay-text=""开启|关闭"" lay-filter=""table-IsPwd""
           value=""{{d.Id}}"" data-json=""{{ encodeURIComponent(JSON.stringify(d)) }}"" {{");
            BeginWriteAttribute("d.IsIsPwd", " d.IsIsPwd =", 1887, "", 1899, 0);
            EndWriteAttribute();
            WriteLiteral("= 0 ? \'checked\' : \'\'}}>\r\n</script>\r\n\r\n<!------------------工具栏------------------------->\r\n<script type=\"text/html\" id=\"toolBar\">\r\n    ");
#nullable restore
#line 49 "C:\Users\Administrator\source\repos\YCProduction\YCProduction.Web\Areas\System\Views\User\Index.cshtml"
...
");
   ...
   ");
                WriteLiteral(@"                 tipSuccess(data.Message);
                }
                else {
        ...
        table.on('tool(UserTable)', function (obj) {
            ...
            //重置密码
                ...
                layer.confirm('确定要操作该用户");
                WriteLiteral(@"密码', function (index) {
