...
namespace YCProduction.Common.File
{
    public class FileHelper
    {
        ...
        public static void Move(string sourceFilePath, string descDirectoryPath)
        {
            ...
            if (IsExistDirectory(descDirectoryPath))
            {
                ...
                {
                    //将文件移动到指定目录
                    System.IO.File.Move(sourceFilePath, descDirectoryPath + "\\" + sourceFilePath);
                }
            }
        }
        #endregion
        ...
        {
            System.IO.File.Copy(sourceFilePath, descDirectoryPath, true);
        }
        #endregion
    ...
    public class HttpDldFile
    {
        ...
        public bool Download(string url, string localfile)
        {
            ...
            if (System.IO.File.Exists(localfile))
            {
                ...
                writeStream = System.IO.File.OpenWrite(localfile);             // 存在则打开要下载的文件
